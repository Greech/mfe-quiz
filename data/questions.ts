  ...
  en: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Yes, by design', score: { techDiversity: 2 } },
        { label: 'Not yet, but we plan migration or integration', score: { techDiversity: 1 } },
      ],
    },
    {
      question: 'How autonomous are your modules or business domains?',
      options: [
        { label: 'Everything is tightly coupled', score: { autonomy: 0 } },
        { label: 'Modules share some code', score: { autonomy: 1 } },
        { label: 'Modules are fully independent', score: { autonomy: 2 } },
      ],
    },
    {
      question: 'How often do teams need to coordinate before deployment?',
      options: [
        { label: 'We always need a joint release', score: { deployment: 0 } },
        { label: 'Sometimes we need to sync up', score: { deployment: 1 } },
        { label: 'Each team deploys independently', score: { deployment: 2 } },
      ],
    },
    {
      question: 'How much time pressure do you have to deliver the first version?',
      options: [
    ...
    {
      question: 'Does your app need SEO indexing or server-side rendering (SSR)?',
      options: [
        { label: 'Yes, SEO is critical', score: { seo: 2 } },
        { label: 'No, it is for logged-in users only', score: { seo: 0 } },
        { label: 'Not sure, but we want the option', score: { seo: 1 } },
      ],
    },
    {
      ...
      options: [
        ...
        { label: 'I know the theory, but never implemented it', score: { experience: 1 } },
    ...
    {
      question: 'How often do you change UX/UI in one module without touching the rest?',
      options: [
        { label: 'That is impossible with our current structure', score: { uxflex: 0 } },
        { label: 'Rather rarely', score: { uxflex: 1 } },
        { label: 'Regularly, that is normal for us', score: { uxflex: 2 } },
      ],
    },
    {
      question: 'Does your team have the operational maturity to manage MFE versioning, integration and testing?',
      options: [
        { label: 'No, that would be chaos', score: { maturity: 0 } },
        { label: 'Not yet, but we want to build it', score: { maturity: 1 } },
        { label: 'Yes, we have processes and tooling', score: { maturity: 2 } },
      ],
    },
  ],
};

export const questions = questionsByLanguage.pl;

export const getQuestions = (language = 'pl') => {
  return questionsByLanguage[language] || questionsByLanguage.pl;
};
